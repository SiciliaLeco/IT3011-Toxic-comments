...
for category in categories:
    ...
    print('Test f1_score is {}'.format(metrics.f1_score(y_test[category], prediction)))
    print('Test f1_score is {}'.format(metrics.accuracy_score(y_test[category], prediction)))
